(function ($) {
  ...
  $(".product-slider-active-3").slick({
    ...
    centerPadding: "0",
    prevArrow:
      '<span class="slider-icon slider-prev"><i class="dlicon arrows-1_small-triangle-left"></i></span>',
    nextArrow:
      '<span class="slider-icon slider-next"><i class="dlicon arrows-1_small-triangle-right"></i></span>',
    responsive: [
      {
        breakpoint: 1500,
        settings: {
  ...
  $(".banner-slider-active").slick({
    ...
    centerPadding: "0",
    prevArrow:
      '<span class="banner-slider-icon slider-prev"><i class="fa fa-angle-left"></i></span>',
    nextArrow:
      '<span class="banner-slider-icon slider-next"><i class="fa fa-angle-right"></i></span>',
    responsive: [
      {
        breakpoint: 1500,
        settings: {
  ...
  $(".product-slider-active-5").slick({
    ...
    centerPadding: "438px",
    prevArrow:
      '<span class="product-slider-icon slider-prev"><i class="fa fa-angle-left"></i></span>',
    nextArrow:
      '<span class="product-slider-icon slider-next"><i class="fa fa-angle-right"></i></span>',
    responsive: [
      {
        breakpoint: 1500,
        settings: {
  ...
  $(".product-slider-active-4").slick({
    ...
    centerPadding: "375px",
    prevArrow:
      '<span class="slider-icon pro-slider-4 slider-prev"><i class="dlicon arrows-1_small-triangle-left"></i></span>',
    nextArrow:
      '<span class="slider-icon pro-slider-4 slider-next"><i class="dlicon arrows-1_small-triangle-right"></i></span>',
    responsive: [
      {
        breakpoint: 1500,
        settings: {
  ...
  $(".timer [data-countdown]").each(function () {
    ...
    $this.countdown(finalDate, function (event) {
      $this.html(
        event.strftime(
          '<span class="cdown day"> <span>%-D </span><p>Days</p></span> <span class="cdown hour"> <span> %-H</span> <p>Hours</p></span> <span class="cdown minutes"><span>%M</span> <p>Minutes</p></span class="cdown second"> <span> <span>%S</span> <p>Seconds</p></span>'
        )
      );
    });
  });
  ...
  $(".featured-slider-active-2").owlCarousel({
    ...
    margin: 30,
    navText: [
      '<i class="dlicon arrows-1_small-triangle-left"></i>',
      '<i class="dlicon arrows-1_small-triangle-right"></i>',
    ],
    responsive: {
      0: {
        items: 1,
  ...
  $("body").on("click", function (e) {
    ...
    // Mobile Menu Close
    if (
      !$($target).is(".header-sidebar-wrap-all3, .clickalbe-menu15-active") &&
      !$($target)
        .parents()
        .is(".header-sidebar-wrap-all3, .clickalbe-menu15-active")
    ) {
  ...
  $(".product-dec-slider").slick({
    ...
    fade: false,
    prevArrow:
      '<span class="pro-dec-icon pro-dec-prev"><i class="dlicon arrows-1_tail-up"></i></span>',
    nextArrow:
      '<span class="pro-dec-icon pro-dec-next"><i class="dlicon arrows-1_tail-down"></i></span>',
    responsive: [
      {
        breakpoint: 767,
        settings: {},
  ...
  $(".product-dec-slider-2").slick({
    ...
    fade: false,
    prevArrow:
      '<span class="pro-dec-icon pro-dec-prev"><i class="dlicon arrows-1_tail-left"></i></span>',
    nextArrow:
      '<span class="pro-dec-icon pro-dec-next"><i class="dlicon arrows-1_tail-right"></i></span>',
    responsive: [
      {
        breakpoint: 767,
        settings: {},
